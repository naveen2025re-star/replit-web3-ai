...
exports.MarketplaceSidebarProvider = void 0;
const vscode = __importStar(require("vscode"));
const secureStorage_1 = require("../security/secureStorage");
class MarketplaceSidebarProvider {
    constructor(_extensionUri, api, context) {
        this._extensionUri = _extensionUri;
        this.api = api;
        this.context = context;
        this.secureStorage = secureStorage_1.SecureStorage.getInstance(context);
    }
    ...
    async handleWebviewMessage(data, webviewView) {
        switch (data.type) {
            case 'getUserInfo':
    ...
    async loadInitialData(webviewView) {
        await this.loadUserInfo(webviewView);
        await this.loadAuditHistory(webviewView);
    }
    async loadUserInfo(webviewView) {
        try {
    ...
    async loadAuditHistory(webviewView) {
        try {
    ...
    async clearUserData(webviewView) {
        const confirm = await vscode.window.showWarningMessage('Clear all SmartAudit AI data? This will remove your API key and cached data.', { modal: true }, 'Clear Data');
    ...
    _getHtmlForWebview(webview) {
        ...
        const scriptUri = webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, 'resources', 'sidebar.js'));
        return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
exports.MarketplaceSidebarProvider = MarketplaceSidebarProvider;
MarketplaceSidebarProvider.viewType = 'smartauditSidebar';
//# sourceMappingURL=marketplaceSidebarProvider.js.map