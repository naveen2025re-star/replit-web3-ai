...
exports.BlockchainLanguageDetector = void 0;
class BlockchainLanguageDetector {
    /**
     * Detect blockchain language from file
     */
    static detectFromFile(document) {
        const fileName = document.fileName;
        const fileExtension = this.getFileExtension(fileName);
        const content = document.getText();
        // Primary detection by file extension
        const languagesByExtension = this.SUPPORTED_LANGUAGES.filter(lang => lang.fileExtensions.includes(fileExtension));
    ...
    static getLanguageByName(name) {
        return this.SUPPORTED_LANGUAGES.find(lang => lang.name.toLowerCase() === name.toLowerCase());
    }
    /**
     * Check if file is supported blockchain language
     */
    static isSupportedFile(document) {
        const fileExtension = this.getFileExtension(document.fileName);
        return this.SUPPORTED_LANGUAGES.some(lang => lang.fileExtensions.includes(fileExtension));
    }
    /**
     ...
     */
    static analyzeContent(content, candidateLanguages) {
        ...
        candidateLanguages.forEach(lang => {
            const langPatterns = patterns[lang.name];
            if (langPatterns) {
     ...
     */
    static getLanguageSpecificChecks(languageName) {
        const checksMap = {
...
exports.BlockchainLanguageDetector = BlockchainLanguageDetector;
BlockchainLanguageDetector.SUPPORTED_LANGUAGES = [
    {
        name: 'Solidity',
...
//# sourceMappingURL=blockchainLanguageDetector.js.map