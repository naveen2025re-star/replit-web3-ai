...
class CorrectedProvider implements vscode.WebviewViewProvider {
    private apiBaseUrl = 'https://a7be7c35-b776-43f4-ab98-9cf31eb0cf08-00-2op4x3uvf85jc.picard.replit.dev';
    ...
    private async handleGetUserInfo(webviewView: vscode.WebviewView) {
        try {
    ...
    private async makeAuthenticatedRequest(apiKey: string): Promise<UserInfo> {
